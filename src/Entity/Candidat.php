...
class Candidat
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Election", inversedBy="candidats")
     * @ORM\JoinColumn(nullable=false)
     */
    private $election;

    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Vote", mappedBy="candidat")
     */
    private $votes;
